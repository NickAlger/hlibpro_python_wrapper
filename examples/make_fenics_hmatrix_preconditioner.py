...
# ct = hpro.build_cluster_tree_from_dof_coords(dof_coords, 60) # <-- still works, but not preferred
...
x3 = spla.gmres(A_csc, y, M=iA_factorized, tol=1e-12, restart=5, maxiter=1)[0]
